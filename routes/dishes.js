...
router.post('/staff', [autho, isStaff], asyncMiddleware(async (req, res) => {
...
router.get('/staff', [autho, isStaff], asyncMiddleware(async (req, res) => {
...
router.get('/customer', [autho], asyncMiddleware(async (req, res) => {
